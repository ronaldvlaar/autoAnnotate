...
dfcw4= pd.read_csv('ckappa_scores.csv')
...
print('min: {m:.4f}, max: {n:.4f}, std: {o:.4f}'.format(m=dflr['ckappa'].min(), n=dflr['ckappa'].max(), o=dflr['ckappa'].std()))
print()
...
print('min: {m:.4f}, max: {n:.4f}, std: {o:.4f}'.format(m=dfld['ckappa'].min(), n=dfld['ckappa'].max(), o=dfld['ckappa'].std()))
...
print('min: {m:.4f}, max: {n:.4f}, std: {o:.4f}'.format(m=dfdr['ckappa'].min(), n=dfdr['ckappa'].max(), o=dfdr['ckappa'].std()))
